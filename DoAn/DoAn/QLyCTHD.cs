...
namespace DoAn
{
    ...
    {
        string updateDateHD   = "Update TableHD SET NgayXuatHD = '" + DateTime.Now.ToString() +"'";
        string oldMaMon;
        string oldSoLuong;
        string oldMaCTHD;
       ...
       private void setMaCTHD()
        ...
        { 
            ...
            else txtTenMon.PlaceholderText = "Sản phẩm không tồn tại!";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                ThanhTien();
                sqlStr3 = "INSERT INTO [dbo].[TableCTHD]([MaCTHD],[MaHD],[MaMon],[TenMon],[SoLuong],[DonGia],[ThanhTien]) VALUES ('" + txtMaCTHD.Text + "','" + txtMaHD.Text + "', '" + txtMaMon.Text + "', N'" + txtTenMon.Text + "','" + txtSoLuong.Text + "','" + txtDonGia.Text + "','" + txtThanhTien.Text + "')";
                MessageBox.Show("Thêm thành công");
                isAdd = true;
            }
            else if (txtTenMon.Text == "Sản phẩm không tồn tại!")
            {
            ...
            {              
                ...
                sqlStr3 = "UPDATE [dbo].[TableCTHD] SET  MaMon = '" + txtMaMon.Text +
